...
Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas ratione eius velit quis odit, repellendus voluptatem nulla in? Culpa natus fugit voluptatum modi repellendus vitae ex inventore exercitationem.
</p>
...
<p className='text_para text-center'>
  World-class care for everyone. Our health Systems offere unmatched, expert health care
</p>
</div>
<ServiceList/>
  </div>
...
<li className="text_para">3. View our physicians who are accepting patients, use the online scheduling to select an appointment</li>
...
<div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-20 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
...
<div className="container">
  ...
  <p className="text_para text-center">World-class care for everyone. Our health System offers umatched, expert healt care</p>
  </div>
  <Testimonial/>
</div>
</section>
